...
/*  Layer 0  (Base Layer) (_AA)  
    ...
    ├────────┬────┬────┬────┬────┬────┬────┬────┬────┬────┬────┬────┬─────┤
    │ Shift  │ Z  │ X  │ C  │ V  │ B  │Ente│ N  │ M  │, < │. > │/ ? │Shift│  // I use an DO (or SA) profile key for the enter key
...
//void matrix_scan_user(void) { // if you have RGB LED's you can use this to have the color indicate the layer
//
//}
//
//void matrix_init_user(void) {
